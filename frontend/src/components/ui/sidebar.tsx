  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-20 flex h-svh w-(--sidebar-width) overflow-hidden transition-[left,right,width] duration-200 ease-linear",
            side === "left"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col overflow-hidden bg-sidebar text-sidebar-foreground group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
