...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("database_id", sa.Integer(), sa.ForeignKey("connected_databases.id", ondelete="CASCADE"), nullable=False, index=True),
    ...
    op.create_index("ix_opportunity_recommendations_database_id", "opportunity_recommendations", ["database_id"])
    ...
    op.create_index("ix_data_products_database_id", "data_products", ["database_id"])
    ...
    op.create_index("ix_warehouse_designs_database_id", "warehouse_designs", ["database_id"])
    ...
    op.create_index("ix_recommendations_database_id", "recommendations", ["database_id"])
    ...
    op.create_index("ix_predictive_readiness_database_id", "predictive_readiness", ["database_id"])
    ...
    op.create_index("ix_agent_capabilities_database_id", "agent_capabilities", ["database_id"])
