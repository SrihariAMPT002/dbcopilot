# Legacy UI to React Parity Mapping

This document maps the legacy Streamlit workflows to the current React frontend so we can preserve feature parity without redesigning business workflows.

## Reference Sources

- Legacy Streamlit app under `ui/`
...
## Legacy API Usage Observed In Streamlit
...
- React is the active frontend implementation; this mapping is retained for parity verification only.
