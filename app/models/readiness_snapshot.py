...
class ReadinessSnapshot(Base):
    ...
    kpi_cluster_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    successful_cluster_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    failed_cluster_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    coverage_percentage: Mapped[float] = mapped_column(nullable=False, default=0.0)
